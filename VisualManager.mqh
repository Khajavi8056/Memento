'CChartObjectRectangleLabel' - undeclared identifier	VisualManager.mqh	117	9
'main_box' - undeclared identifier	VisualManager.mqh	117	36
'main_box' - some operator expected	VisualManager.mqh	117	36
'main_box' - undeclared identifier	VisualManager.mqh	118	9
'main_box' - undeclared identifier	VisualManager.mqh	119	9
'main_box' - undeclared identifier	VisualManager.mqh	120	9
'main_box' - undeclared identifier	VisualManager.mqh	121	9
'main_box' - undeclared identifier	VisualManager.mqh	122	9
'CChartObjectRectangleLabel' - undeclared identifier	VisualManager.mqh	133	9
'sub_panel' - undeclared identifier	VisualManager.mqh	133	36
'sub_panel' - some operator expected	VisualManager.mqh	133	36
'sub_panel' - undeclared identifier	VisualManager.mqh	134	9
'sub_panel' - undeclared identifier	VisualManager.mqh	135	9
'sub_panel' - undeclared identifier	VisualManager.mqh	136	9
'sub_panel' - undeclared identifier	VisualManager.mqh	137	9
'sub_panel' - undeclared identifier	VisualManager.mqh	138	9
'sub_panel' - undeclared identifier	VisualManager.mqh	139	9
'Hidden' - undeclared identifier	VisualManager.mqh	150	22
'true' - some operator expected	VisualManager.mqh	150	29
'Hidden' - undeclared identifier	VisualManager.mqh	150	45
'true' - some operator expected	VisualManager.mqh	150	52
'SYMBOL_ARROWUP' - undeclared identifier	VisualManager.mqh	304	27
'SYMBOL_ARROWDOWN' - undeclared identifier	VisualManager.mqh	304	44
wrong parameters count, 5 passed, but 6 requires	VisualManager.mqh	306	14
   bool CChartObjectArrow::Create(long,const string,const int,const datetime,const double,const char)	ChartObjectsArrows.mqh	20	22
wrong parameters count, 5 passed, but 4 requires	VisualManager.mqh	273	14
   bool CChartObjectVLine::Create(long,const string,const int,const datetime)	ChartObjectsLines.mqh	20	22
wrong parameters count, 1 passed, but 0 requires	IchimokuLogic.mqh	162	26
   void CVisualManager::InitDashboard()	VisualManager.mqh	59	10
wrong parameters count, 1 passed, but 0 requires	IchimokuLogic.mqh	185	26
   void CVisualManager::UpdateDashboard()	VisualManager.mqh	60	10
'if' - semicolon expected	IchimokuLogic.mqh	189	5
'ClearGraphics' - undeclared identifier	IchimokuLogic.mqh	207	30
')' - expression expected	IchimokuLogic.mqh	207	44
'ClearGraphics' - undeclared identifier	IchimokuLogic.mqh	213	30
')' - expression expected	IchimokuLogic.mqh	213	44
32 errors, 0 warnings		32	0





ببین راستی از کتابخانه کرافیک متاتریدر کار برای رسم اون حالت اسکن نکیشه فکر کنم خودش داره بین
